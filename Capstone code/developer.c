...
void display_developer_copyright() {
    ...
    if (GetConsoleScreenBufferInfo(hConsole, &csbi)) {
        ...
        int linesToBottom = consoleHeight - currentY - 6; // 6 lines for copyright text
    ...
    // Print copyright in bottom right corner
    set_console_color(COLOR_YELLOW);
    printf("%*s", CONSOLE_WIDTH - 30, "");
    printf("(C) 2025 Developed by:\n");

    printf("%*s", CONSOLE_WIDTH - 30, "");
    printf("H.M.Ashis Rahman\n");

    printf("%*s", CONSOLE_WIDTH - 30, "");
    printf("MD.Yeasif Jani Mishad\n");
